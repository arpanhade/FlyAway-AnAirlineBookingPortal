...
public class Dao {
	...
	public Dao() throws ClassNotFoundException, SQLException{
		...
		con=DriverManager.getConnection("jdbc:mysql://localhost:3306/flyaway","root","Vinayak13/05");
	...
	public boolean addPassenger(HashMap<String, String> passenger) throws SQLException {
		
		String query1 = "INSERT INTO passenger (pname, age, gender) VALUES" + " ('"
				+ StringUtil.fixSqlFieldValue(passenger.get("pname")) + "'," + " '" + StringUtil.fixSqlFieldValue(passenger.get("age")) 
				+ "'," + " '" + StringUtil.fixSqlFieldValue(passenger.get("gender")) + "')";
	...
	public boolean doPaymemnt() throws SQLException {
		try {
			return true;
		} catch (Exception e) {
			System.out.print("error");
